...
/**
 * Caso de uso para obtener solo los servicios activos de una categoría específica
 */
export class GetActiveServicesByCategory {
  constructor(
  ...
  /**
   * Ejecuta la búsqueda de servicios activos por categoría
